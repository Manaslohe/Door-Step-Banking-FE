...
const AgentLogin = () => {
  ...
  return (
    <div className="min-h-screen h-auto bg-gradient-to-br from-orange-50 to-orange-100 flex flex-col overflow-hidden">
      <QuoteBar />
        ...
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
          <div className="flex items-center mb-8">
            ...
            <div className="flex items-center ml-4">
              <UserCog className="w-8 h-8 text-orange-600 mr-3" />
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-orange-600 text-white py-3 rounded-lg hover:bg-orange-700 transition-all flex items-center justify-center space-x-2 disabled:opacity-50"
            >
              {loading ? (
